...
import com.reactive.brewery.bootstrap.BeerLoader;
import com.reactive.brewery.web.functional.BeerRouterConfig;
...
public class WebClientV2IT {
    ...
    void getBeerByUpc() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL_UPC + "/" + BeerLoader.BEER_3_UPC)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
    ...
    void getBeerByUpcNotFound() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL_UPC + "/UPCCCID")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
